const copy = {
  ...
  he: {
    ...
    fields: {
      ...
      selectedAmount: 'סכום שנבחר',
      selectedItem: 'פריט שנבחר לתרומה',
      dedication: 'הקדשה',
      currency: 'מטבע',
      message: 'הודעה אישית',
    },
...
const formatFields = (data, labels) => [
  ...
  { label: labels.selectedAmount, value: data.selectedAmount },
  { label: labels.selectedItem, value: data.selectedItem },
