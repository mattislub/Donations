...
export const uiTranslations = {
  en: {
    ...
    personalPage: {
      ...
      detailTitle: 'Personal donation page',
      detailDescription:
        'Review the donations already received and contribute directly through the selected page.',
      detailEyebrow: 'Selected fundraiser',
      newDonationAction: 'Make a new donation',
      goalLabel: 'Goal',
      raisedLabel: 'Raised',
      remainingLabel: 'Remaining',
      percentLabel: 'Goal completion',
      donationListTitle: 'Donations received',
      donationListEmpty: 'No donations have been received yet.',
      statusTitle: 'Goal status',
      statusDescription: 'An overview of progress toward the personal target.',
      selectPrompt: 'Choose a personal page above to view its donation details.',
      anonymousDonor: 'Anonymous donor',
      sampleDonors: ['Cohen family', 'Leah & David', 'Community supporter'],
      ...
      manageMenu: {
        ...
        donationSummary: 'Total donations received',
        donationTotalAmount: 'Total donation amount',
        donationCreditCount: 'Donations by credit card',
  ...
  he: {
    ...
    personalPage: {
      ...
      detailTitle: 'דף תרומה אישי',
      detailDescription: 'צפו בתרומות שכבר התקבלו ותרמו ישירות דרך הדף הנבחר.',
      detailEyebrow: 'מגייס נבחר',
      newDonationAction: 'תרומה חדשה',
      goalLabel: 'יעד',
      raisedLabel: 'התקבל עד כה',
      remainingLabel: 'נותר',
      percentLabel: 'אחוז מהיעד',
      donationListTitle: 'תרומות שהתקבלו',
      donationListEmpty: 'טרם התקבלו תרומות.',
      statusTitle: 'סטטוס היעד',
      statusDescription: 'תמונת מצב של ההתקדמות אל היעד האישי.',
      selectPrompt: 'בחרו דף תרומה מהרשימה כדי לצפות בפרטים.',
      anonymousDonor: 'תורם אנונימי',
      sampleDonors: ['משפחת כהן', 'לאה ודוד', 'תומך מהקהילה'],
      ...
      manageMenu: {
        ...
        donationSummary: 'סיכום כמות תרומות שהתקבלו',
        donationTotalAmount: 'סכום כולל של התרומות',
        donationCreditCount: 'כמה תרומות באשראי',
