...
export const uiTranslations = {
  en: {
    ...
    donations: {
      ...
      amountOptionTitle: 'Choose a donation amount',
      amountOptionDescription: 'Pick a predefined amount for a quick contribution.',
      amountOptions: ['$180', '$360', '$720', '$1,800'],
      itemOptionTitle: 'Choose an item to donate',
      itemOptionDescription: 'Select a specific item below and see exactly how much it costs.',
      itemCostLabel: 'Item price',
      costLabel: 'per unit',
      unitsLabel: 'Units',
    ...
    donateNowFlow: {
      ...
      customAmountAction: 'Continue to donor details',
      selectAmountFirstAction: 'Select an amount to continue',
  ...
  he: {
    ...
    donations: {
      ...
      optionsTitle: 'אפשרויות תרומה',
      amountOptionTitle: 'בחירת סכום לתרומה',
      amountOptionDescription: 'בחרו סכום מהיר לתרומה מיידית.',
      amountOptions: ['₪180', '₪360', '₪720', '₪1,800'],
      itemOptionTitle: 'בחירת פריט לתרומה',
      itemOptionDescription: 'בחרו פריט מהרשימה למטה וראו בדיוק כמה הוא עולה.',
      itemCostLabel: 'מחיר הפריט',
      costLabel: 'ליחידה',
    ...
    donateNowFlow: {
      ...
      customAmountAction: 'המשך למילוי פרטי תורם',
      selectAmountFirstAction: 'בחרו סכום כדי להמשיך',
