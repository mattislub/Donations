              ...
              <div className="admin-crm-layout">
                ...
                <section className="admin-crm-main">
                  <div className="admin-crm-header">
                    <div>
                      <h4>{t.admin.crm.title}</h4>
                      <p>{t.admin.crm.description}</p>
                    </div>
                    <div className="admin-crm-actions">
                      {t.admin.crm.actions.map((action) => (
                  ...
                  <div className="admin-crm-modules">
                    {t.admin.crm.modules.map((module) => (
                      <article key={module.title} className="admin-crm-module">
                        <h5>{module.title}</h5>
